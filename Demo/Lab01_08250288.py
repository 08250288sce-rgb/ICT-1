...
student_list.append("Ugyen")#adding student name to the list
student_list.append("Kezang")#adding student name to the list
student_list.append("Dechen")#adding student name to the list
student_age.add(24)#adding student age to the set
student_age.add(26)#adding student age to the set
student_age.add(28)#adding student age to the set
student_age.add(30)#adding student age to the set
student_grade.add('A')#adding student grade to the set
student_grade.add('A')#adding student grade to the set
student_grade.add('A')#adding student grade to the set
student_grade.add('A')#adding student grade to the set
student_dict['Dorji'] = {'age': 24, 'grade': 'A'}#adding student details to the dictionary
student_dict['Ugyen'] = {'age': 26, 'grade': 'A'}#adding student details to the dictionary
student_dict['Kezang'] = {'age': 28, 'grade': 'A'}#adding student details to the dictionary
student_dict['Dechen'] = {'age': 30, 'grade': 'A'}#adding student details to the dictionary
